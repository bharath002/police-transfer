<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminQPage.aspx.cs" Inherits="AdminQPage" MasterPageFile="MasterPage.master" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Verdana"
    ...
    <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
        ...
        Text="Qualification Name" Width="167px"></asp:Label>
    ...
    <asp:Label ID="Label3" runat="server" BackColor="Purple" Font-Bold="True" Font-Names="Verdana"
        ...
        position: absolute; top: 271px" Text="Qualification Details" Width="412px"></asp:Label>
