<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminTransfer.aspx.cs" Inherits="AdminTransfer" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Verdana"
    ...
    <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
        ...
        Text="Transfer To" Width="167px"></asp:Label>
    &nbsp;
    ...
    <asp:DropDownList ID="DropDownList2" runat="server" 
        ...
        DataSourceID="SqlDataSource3" DataTextField="StationCode" 
        DataValueField="StationCode">
    </asp:DropDownList>
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnConnectionString %>" 
        SelectCommand="SELECT [StationCode] FROM [StationTab] ORDER BY [StationCode]">
    </asp:SqlDataSource>
    ...
    <asp:Label ID="Label3" runat="server" BackColor="Purple" Font-Bold="True" Font-Names="Verdana"
        ...
        position: absolute; top: 269px" Text="Staff Transfer" Width="412px"></asp:Label>
