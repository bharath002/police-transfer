...
public partial class AdminTransfer : System.Web.UI.Page
{
    ...
    {
        Conn.Open();
        SqlStr = "update EmpTab set stationcode='" + DropDownList2.Text + "' where empcode='" + Session["e1var"] +"'";
        ...
        int n1Var = 0;
        Conn.Open();
        SqlCommand cmd = new SqlCommand("select Max(TranNo)+1 as NewNo from TransferTab", Conn);
        ...
        Conn.Open();
        SqlStr = "Insert into TransferTab values(" + n1Var + ",'" + string.Format("{0:dd/MMM/yyyy}", DateTime.Today) + "','" + Session["e1var"] + "','" + s1var + "','" + DropDownList2.Text + "','" + TextBox1.Text + "','" + TextBox2.Text + "')";
