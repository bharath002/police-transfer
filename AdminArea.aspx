<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminArea.aspx.cs" Inherits="AdminArea" Title="Untitled Page" %>
...
<asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Verdana"
    ...
    <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="Medium"
        ...
        Text="Covering Areas" Width="167px"></asp:Label>
    &nbsp;
    ...
    <asp:Label ID="Label3" runat="server" BackColor="Purple" Font-Bold="True" Font-Names="Verdana"
        ...
        position: absolute; top: 271px" Text="Area Names Entry" Width="412px"></asp:Label>
    <asp:TextBox ID="TextBox2" runat="server" Height="94px" Style="z-index: 112; left: 402px;
