<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminQList.aspx.cs" Inherits="AdminQList" MasterPageFile="MasterPage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Verdana"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cnConnectionString %>"
        SelectCommand="SELECT * FROM [QualificationTab] ORDER BY [qName]">
    </asp:SqlDataSource>
    ...
    <asp:Label ID="Label3" runat="server" BackColor="Purple" Font-Bold="True" Font-Names="Verdana"
        ...
        position: absolute; top: 231px" Text="Qualification  List" Width="848px"></asp:Label>
